...
const privacyContent = {
    ...
    ru: {
        ...
        company: {
            ...
            name: "AQUA ROOKS S.A.",
            address: "Commune Lac 2 / Canton d'Aklakou, Togo",
            representative: "Представляет: Rodrigue Mahouton Guedou",
            contact: "Контакт:",
            phone: "Телефон: +228 90 62 80 29",
            email: "E‑mail: office@aqua-rooks.com",
            register: "Запись в реестре: внесена в торговый реестр Ломе, Того",
            registerCourt: "Регистрирующий суд: Ломе",
        },
        responsible: {
        ...
        disclaimer: {
            ...
            content: {
                ...
                text: "Содержание нашего веб‑сайта создано с особой тщательностью. Тем не менее AQUA ROOKS S.A. не несет ответственности за точность, полноту и актуальность предоставленного содержания. В качестве поставщика услуг мы отвечаем только за собственное содержание этих страниц в соответствии с общими законами. Любая дальнейшая ответственность исключается.",
            },
            links: {
                title: "Ответственность за внешние ссылки",
                text: "Наш веб‑сайт может содержать ссылки на внешние веб‑сайты третьих лиц, на содержание которых мы не имеем никакого влияния. Поэтому мы не можем нести ответственность за это внешнее содержание. За содержание страниц, на которые ведут ссылки, всегда несет ответственность соответствующий поставщик или оператор. На момент размещения ссылки возможные нарушения закона были проверены; незаконное содержание на тот момент не было выявлено. Постоянный контроль содержания связанных страниц без конкретных указаний на нарушение закона не является разумным. При получении сведений о нарушениях закона мы немедленно удалим такие ссылки.",
            },
            copyright: {
                title: "Авторское право",
                text: "Содержание и произведения, созданные AQUA ROOKS S.A. на этом веб‑сайте, подпадают под действие законодательства Того и международного законодательства об авторском праве. Вклад третьих лиц помечен соответствующим образом. Воспроизведение, обработка, распространение или иное использование за пределами закона об авторском праве требует письменного согласия соответствующего правообладателя.",
            },
        },
        dataCollection: {
            title: "Сбор и хранение персональных данных, а также характер и цель их использования",
            visit: {
                title: "a) Посещение веб‑сайта",
                text: "При посещении нашего веб‑сайта информация автоматически передается браузером вашего устройства на наш сервер. Эта информация может включать:",
                items: [
                    "IP‑адрес",
                    "дату и время доступа",
                    "название и URL запрошенного файла",
                    "веб‑сайт, с которого осуществляется доступ",
                    "тип и версию браузера",
                    "операционную систему",
                ],
                purpose: "Эти данные обрабатываются для обеспечения бесперебойного установления соединения, удобного использования веб‑сайта, а также для технической безопасности.",
            },
            contact: {
                title: "Контакт",
                text: "Если вы связываетесь с нами по телефону или электронной почте, мы сохраняем предоставленные вами добровольно данные (например, имя, номер телефона, адрес электронной почты, запрос), чтобы обработать ваше обращение.",
            },
            cookies: {
                title: "Cookies",
                text: "Наш веб‑сайт может использовать cookies для упрощения использования, оптимизации содержания или проведения статистических оценок. Вы можете настроить свой браузер так, чтобы cookies не сохранялись.",
            },
            sharing: {
                title: "Передача данных",
                text: "Передача персональных данных третьим лицам осуществляется только:",
                items: [
                    "если вы явно дали на это согласие,",
                    "если это необходимо для выполнения законных обязанностей,",
                    "или если передача необходима для исполнения договора.",
                ],
            },
            analytics: {
                title: "Инструменты анализа / отслеживания",
                text: "Если используются инструменты анализа (например, Google Analytics), это делается исключительно на основании законных интересов или вашего согласия.",
            },
            rights: {
                title: "Права субъектов данных",
                text: "Вы имеете право на:",
                items: [
                    "получение информации о хранящихся персональных данных",
                    "исправление неверных данных",
                    "удаление ваших данных (если этому не противоречат законные обязательства по хранению)",
            ...
            security: {
                ...
                text: "Мы используем технические и организационные меры для защиты данных от потери, злоупотребления или несанкционированного доступа.",
            },
            updates: {
                title: "Актуальность и изменение политики конфиденциальности",
                text: "Настоящая политика конфиденциальности обновляется по мере необходимости. Актуальная версия доступна на нашем веб‑сайте.",
            },
        },
    },
};
